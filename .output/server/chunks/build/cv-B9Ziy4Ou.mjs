const cvProfile = {
  ...
  summary: "Full-Stack Engineer with 6+ years of experience building scalable, high-performance web applications across regulated environments."
};
const cvSkills = {
  ...
  backend: ["Node.js", "NestJS", "Express.js", "REST", "GraphQL", "Spring Boot"],
  databases: ["PostgreSQL", "MySQL", "MongoDB", "Prisma", "TypeORM", "Mongoose"],
...
const cvEducation = "B.Eng. Mechanical Engineering, Niger Delta University (2006 - 2012)";
const cvLanguages = ["English (Fluent)", "German (Basic - A2)"];

export { cvExperience as a, cvEducation as b, cvProfile as c, cvLanguages as d, cvSkills as e };
//# sourceMappingURL=cv-B9Ziy4Ou.mjs.map
